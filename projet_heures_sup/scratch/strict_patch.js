...
const newSrc = src.substring(0, startIndex) + newRoute + src.substring(endIndex);
fs.writeFileSync('server.js', newSrc, 'utf8');
console.log('Fixed correctly via exact indexes!');
